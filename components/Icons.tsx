...
export const BeakerIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 0 1-.659 1.591L5 14.5M9.75 3.104c.228-.043.46-.073.7-.094A2.25 2.25 0 0 1 12.75 1h.008a2.25 2.25 0 0 1 2.242 2.006c.034.175.056.353.07.534m-3.07 1.993c.03.022.06.044.09.065L18 14.5M15 9.75h3.75M15 12h3.75M15 14.25h3.75M15 16.5h3.75M7.5 14.5c0 3.314 2.686 6 6 6s6-2.686 6-6M4.5 18.75a2.25 2.25 0 0 1 2.25-2.25h10.5a2.25 2.25 0 0 1 2.25 2.25" />
    </svg>
);